...
public class SmileDBScanClustererTest {
     ...
     *
     */
    public SmileDBScanClustererTest() {
    ...
    public void testCluster() {
        ...
        clusterer = new SmileDBScanClusterer();
        List<Cluster> clusters = clusterer.cluster(corpus);

        System.out.println("Clusters:");
        clusters.forEach(System.out::println);

        // The DBScan algorithm produces a "noise" cluster, which may or may not be empty
        // although we are really expecting this corpus to produce 2 clusters, we say 3 to account for that
        ...
        // The noise cluster will be empty
        Cluster noiseCluster = new Cluster("Cluster 3");
        List<Cluster> expectedClusters = Arrays.asList(expectedCluster1, expectedCluster2, noiseCluster);
